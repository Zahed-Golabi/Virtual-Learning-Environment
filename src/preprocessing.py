...
class Preprocessing:
    ...
    def run(self) -> None:
        ...
        self.replace_values(
            ...
            ["2013-Feb", "2013-Oct", "2014-Feb", "2014-Oct"],
        )
    ...
    def fill_values(self, column):
        ...
        self.df[column] = self.df.apply(
            lambda row: self.df[self.df["region"] == row["region"]]["imd_band"].mode()[0]
            if pd.isna(row["imd_band"])
            else row["imd_band"],
            axis=1,
        )
    ...
    def feature_extraction(self):
        ...
        new_columns = {
            "total_dataplus_clicks": insert(9),
            "total_dualpane_clicks": insert(10),
            "total_external_quiz_clicks": insert(11),
            "total_folder_clicks": insert(12),
            "total_forum_clicks": insert(13),
            "total_glossary_clicks": insert(14),
            "total_homepage_clicks": insert(15),
            "total_hrml_clicks": insert(16),
            "total_collaborate_clicks": insert(17),
            "total_content_clicks": insert(18),
            "total_elluminate_clicks": insert(19),
            "total_wiki_clicks": insert(20),
            "total_page_clicks": insert(21),
            "total_questionnaire_clicks": insert(22),
            "total_quiz_clicks": insert(23),
            "total_repeated_clicks": insert(24),
            "total_resource_clicks": insert(25),
            "total_shared_clicks": insert(26),
            "total_subpage_clicks": insert(27),
            "total_url_clicks": insert(28),
        }
        ...
        self.df.insert(
            loc=len(self.df.columns) - 1, column="total_clicks", value=total_clicks
        )
